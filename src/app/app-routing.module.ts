...
const routes: Routes = [
  ...
  {path:'productos-proveedores/:idProducto', component:ProductoProveedoresComponent, canActivate: [adminGuard]},
  {path:'productos-proveedores/:idProducto/nuevo', component:ProductSupplierFormComponent, canActivate: [adminGuard]},
  ...
  {path:'clientes', component:CostumerComponent, canActivate: [adminGuard]},
  {path:'proveedores', component:SupplierComponent, canActivate: [adminGuard]},
  {path:'precios-productos', component:ProductsPricesComponent, canActivate: [adminGuard]},
  {path:'precios-productos/:idProducto/:idPersona', component:PricesComponent, canActivate: [adminGuard]},
];
